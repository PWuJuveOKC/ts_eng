...
Alldat['Label'] = [0] * len(files_ECG) + [1] * len(files_ART) + [2] * len(files_CO2) + \
                  [3] * len(files_PAP);

Alldat.to_csv('Data/Med_feature.csv',index=None)
...
norm_features['Label'] = [0] * len(files_ECG) + [1] * len(files_ART) + [2] * len(files_CO2) + \
                  [3] * len(files_PAP);

norm_features.to_csv('Data/Med_feature_norm.csv',index=None)